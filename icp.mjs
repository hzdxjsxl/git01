...
function svd3x3(H) {
  ...
  const U = [
    [H[0][0]*Vmat[0][0]*invS[0]+H[0][1]*Vmat[0][1]*invS[0]+H[0][2]*Vmat[0][2]*invS[0],
     H[0][0]*Vmat[1][0]*invS[1]+H[0][1]*Vmat[1][1]*invS[1]+H[0][2]*Vmat[1][2]*invS[1],
     H[0][0]*Vmat[2][0]*invS[2]+H[0][1]*Vmat[2][1]*invS[2]+H[0][2]*Vmat[2][2]*invS[2]],
    [H[1][0]*Vmat[0][0]*invS[0]+H[1][1]*Vmat[0][1]*invS[0]+H[1][2]*Vmat[0][2]*invS[0],
     H[1][0]*Vmat[1][0]*invS[1]+H[1][1]*Vmat[1][1]*invS[1]+H[1][2]*Vmat[1][2]*invS[1],
     H[1][0]*Vmat[2][0]*invS[2]+H[1][1]*Vmat[2][1]*invS[2]+H[1][2]*Vmat[2][2]*invS[2]],
    [H[2][0]*Vmat[0][0]*invS[0]+H[2][1]*Vmat[0][1]*invS[0]+H[2][2]*Vmat[0][2]*invS[0],
     H[2][0]*Vmat[1][0]*invS[1]+H[2][1]*Vmat[1][1]*invS[1]+H[2][2]*Vmat[1][2]*invS[1],
     H[2][0]*Vmat[2][0]*invS[2]+H[2][1]*Vmat[2][1]*invS[2]+H[2][2]*Vmat[2][2]*invS[2]],
  ];
  ...
  const Vt = [[Vmat[0][0],Vmat[1][0],Vmat[2][0]],[Vmat[0][1],Vmat[1][1],Vmat[2][1]],[Vmat[0][2],Vmat[1][2],Vmat[2][2]]];
  return { U, S: sVals, V: Vt };
}
