...
export class IDWCalculator {
    ...
    interpolateGrid(minX, minY, maxX, maxY, gridWidth, gridHeight, options) {
    ...
    interpolateGridFast(minX, minY, maxX, maxY, gridWidth, gridHeight, sampleRate = 2) {
    ...
    static benchmark(points, gridSize = 200, iterations = 3) {
